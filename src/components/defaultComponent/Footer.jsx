    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400">
              ...
              আমাদের লক্ষ্য হলো উচ্চমানের পণ্য এবং ব্যতিক্রমী গ্রাহক সেবা প্রদান
              করা।
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span className="text-gray-400">১২৩ প্রধান সড়ক, শহর, দেশ</span>
              </li>
              <li className="flex items-center">
                <FaPhoneAlt className="text-gray-400 mr-2" />
                <span className="text-gray-400">+৮৮ ১২৩ ৪৫৬ ৭৮৯০</span>
              </li>
              <li className="flex items-center">
        ...
        <div className="mt-12">
          ...
          <form action="#" method="POST" className="flex flex-col sm:flex-row">
            <input
              ...
              className="flex-1 p-3 mb-2 sm:mb-0 rounded-lg border border-gray-700 bg-gray-900 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button
              type="submit"
              className="mt-2 sm:mt-0 sm:ml-4 bg-blue-500 text-white py-2 px-6 rounded-lg shadow-lg hover:bg-blue-600 transition-colors"
            >
              সাবস্ক্রাইব
            </button>
          </form>
        ...
        <div className="border-t border-gray-700 mt-12 pt-4 text-center text-gray-400 text-sm">
          ...
          <p>
            © {new Date().getFullYear()} আপনার কোম্পানি। সমস্ত অধিকার সংরক্ষিত।
          </p>
        </div>
      </div>
    </footer>
